 ...
 */
package org.hibernate.ogm.test.integration.orientdb.service;
...
public class PhoneNumberService {
	...
	public PhoneNumber getPhoneNumber(String name) {
		List<PhoneNumber> result = entityManager.createNativeQuery( "select * from PhoneNumber where name = :name", PhoneNumber.class )
